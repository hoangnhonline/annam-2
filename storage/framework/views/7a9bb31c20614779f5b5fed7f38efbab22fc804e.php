						...
						<div class="block-content">
							<form action="billing-infomation_submit" method="get" class="form-billing">
								...
								<div class="form-group">
									...
									<div class="form-group">
										<div class="thumb">
											<img src="<?php echo e(Helper::showImage($bank->image_url)); ?>" alt="<?php echo e($bank->name); ?>">
										</div>
										<div class="des">
											<p class="title"><?php echo e($bank->name); ?></p>
											<p class="info">
												<?php echo e($bank->description); ?>
					...
					<div class="block block-billing-product block-info-address">
						...
						<div class="block-content">
							<p>
								...
								<span class="info"><?php echo e($info['full_name']); ?></span>
							</p>
							<p>
								<span class="title">Địa chỉ:</span>
								<span class="info"><?php echo e($info['address']); ?></span>
							</p>
							<p>
								<span class="title">Điện thoại di động:</span>
								<span class="info"><?php echo e($info['phone']); ?></span>
							</p>
							<p>
								<span class="title">Email:</span>
								<span class="info"><?php echo e($info['email']); ?></span>
							</p>
							<p>
								<span class="title">Ngày đặt hàng:</span>
								<span class="info"><?php echo e(date('d/M/Y', time())); ?></span>
							</p>
						</div>
					</div>
						...
						<?php $total = 0; ?>
							<table class="table-billing-product">
								...
								<tbody>
									...
									<tr>
										<td>
											<p class="tb-commom"><a href="<?php echo e(route('product-detail', [$product->slug])); ?>" target="_blank" title="<?php echo $product->name; ?>"><?php echo $product->name; ?></a></p>
											<p class="tb-commom">Số lượng: x <?php echo e($getlistProduct[$key]); ?></p>
											<p class="tb-commom">
												Màu sắc sản phẩm:
												<span class="tb-img"><img src="<?php echo e(Helper::showImage($colorArr[$tmp[1]]->image_url )); ?>" alt="<?php echo e(($colorArr[$tmp[1]]->name )); ?>" width="20"></span>
											</p>
											<p class="tb-commom">Size sản phẩm: <span class="tb-commom1"><?php echo e($sizeArr[$tmp[2]]->name); ?></span></p>
											</p>
										</td>
										<?php 
										...
										?>
										<td>
											<strong class="text-right"><?php echo e(number_format($total_per_product)); ?>đ</strong>
										</td>
									</tr>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<?php echo $settingArr['thong_bao_thanh_cong']; ?>

						<div class="text-right">
							<a href="<?php echo e(route('home')); ?>" title="Trở về trang chủ" class="btn btn-danger"> Trở về trang chủ</a>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	$('document').ready(function(){
		$('#btnFinish').click(function(){
			...
			$.ajax({
				url : "<?php echo e(route('save-final')); ?>",
				type : 'POST',
				data : {
