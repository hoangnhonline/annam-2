...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(route('inventory.index')); ?>">Sản phẩm mới</a></li>
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="<?php echo e(route('inventory.index', ['parent_id' => $detail->parent_id, 'cate_id' => $detail->cate_id])); ?>" style="margin-bottom:5px">Quay lại</a>
    <a class="btn btn-primary btn-sm" href="<?php echo e(route('product-detail', [$detail->slug] )); ?>" target="_blank" style="margin-top:-6px"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>
    <form role="form" method="POST" action="<?php echo e(route('inventory.update')); ?>" id="dataForm">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-footer">             
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="<?php echo e(route('inventory.index', ['parent_id' => $detail->parent_id, 'cate_id' => $detail->cate_id])); ?>">Hủy</a>
            </div>
  ...
  if(e.which == 13) {
    ...
    $(document).ready(function(){
      ...
      $('#parent_id').change(function(){
        location.href="<?php echo e(route('inventory.create')); ?>?parent_id=" + $(this).val();
      })
      $(".select2").select2();
