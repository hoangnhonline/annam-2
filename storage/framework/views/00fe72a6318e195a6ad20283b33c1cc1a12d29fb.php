						...
						<div class="col-sm-4 col-xs-12">
							<div class="item time">
								...
								<p>
									...
									<span class="info"><?php echo $settingArr['gio_lam_viec']; ?></span>
								</p>
							</div>	
						</div>
						<div class="col-sm-4 col-xs-12">
	...
	<div class="menu">
		...
		<div class="block-cart-mb">
			<a href="#" onclick="return false;" title="Cart" data-toggle="modal" data-target="#Cart">
				...
				<span><?php echo Session::get('products') ? array_sum(Session::get('products')) : 0; ?></span>
			</a>
		</div>
		<nav class="menu-top">
			<div class="container">
				<ul class="nav-menu">					
					...
					<li class="cart">
						<a href="#" onclick="return false;" class="cart-link">
							...
							<span><?php echo Session::get('products') ? array_sum(Session::get('products')) : 0; ?> Sản phẩm</span>
						</a>
					</li>
				</ul>
			</div>
