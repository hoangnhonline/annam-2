                    ...
                    <div role="tabpanel" class="tab-pane active" id="home">
                        ...
                        <div class="form-group">
                          ...
                          <ul>
                            ...
                            <li class="col-md-2" style="list-style:none">
                                <label>
                                  <input type="checkbox" class="color_id" name="color_id[]" <?php echo e(in_array($color->id, old('color_id', $colorSelected)) ? "checked" : ""); ?> value="<?php echo e($color->id); ?>">
                        ...
                        <div class="form-group">
                          ...
                          <ul>
                            ...
                            <li class="col-md-2" style="list-style:none">
                                <label>
                                  <input type="checkbox" class="size_id" name="size_id[]" <?php echo e(in_array($size->id, old('size_id', $sizeSelected)) ? "checked" : ""); ?> value="<?php echo e($size->id); ?>">
